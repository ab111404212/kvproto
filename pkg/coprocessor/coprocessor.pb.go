...
type Response struct {
	...
	RegionError *Error                                                 `protobuf:"bytes,2,opt,name=region_error,json=regionError,proto3" json:"region_error,omitempty"`
	...
	ExecDetails *ExecDetails `protobuf:"bytes,6,opt,name=exec_details,json=execDetails,proto3" json:"exec_details,omitempty"`
	// This field is provided in later versions, containing more detailed
	// information.
	ExecDetailsV2    *ExecDetailsV2 `protobuf:"bytes,11,opt,name=exec_details_v2,json=execDetailsV2,proto3" json:"exec_details_v2,omitempty"`
...
func (m *Response) GetRegionError() *Error {
	if m != nil {
...
func (m *Response) GetLocked() *LockInfo {
	if m != nil {
		return m.Locked
	}
	return nil
...
func (m *Response) GetExecDetailsV2() *ExecDetailsV2 {
	if m != nil {
...
func (m *RegionInfo) GetRegionEpoch() *RegionEpoch {
	if m != nil {
...
func (m *BatchRequest) GetContext() *Context {
	if m != nil {
		return m.Context
	}
	return nil
...
type BatchResponse struct {
	...
	ExecDetails          *ExecDetails                                           `protobuf:"bytes,3,opt,name=exec_details,json=execDetails,proto3" json:"exec_details,omitempty"`
	RetryRegions         []*Region                                              `protobuf:"bytes,4,rep,name=retry_regions,json=retryRegions,proto3" json:"retry_regions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                                               `json:"-"`
	XXX_unrecognized     []byte                                                 `json:"-"`
	XXX_sizecache        int32                                                  `json:"-"`
}
...
func (m *BatchResponse) GetExecDetails() *ExecDetails {
	if m != nil {
		return m.ExecDetails
	}
	return nil
...
func (m *BatchResponse) GetRetryRegions() []*Region {
	if m != nil {
