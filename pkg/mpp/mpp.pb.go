...
type FillMaterializedViewRequest struct {
	BaseDbName           []byte   `protobuf:"bytes,1,opt,name=base_db_name,json=baseDbName,proto3" json:"base_db_name,omitempty"`
	BaseTableName        []byte   `protobuf:"bytes,2,opt,name=base_table_name,json=baseTableName,proto3" json:"base_table_name,omitempty"`
	MvDbName             []byte   `protobuf:"bytes,3,opt,name=mv_db_name,json=mvDbName,proto3" json:"mv_db_name,omitempty"`
	MvTableName          []byte   `protobuf:"bytes,4,opt,name=mv_table_name,json=mvTableName,proto3" json:"mv_table_name,omitempty"`
...
func (m *FillMaterializedViewRequest) Reset()         { *m = FillMaterializedViewRequest{} }
func (m *FillMaterializedViewRequest) String() string { return proto.CompactTextString(m) }
...
func (m *FillMaterializedViewRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FillMaterializedViewRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FillMaterializedViewRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FillMaterializedViewRequest.Merge(m, src)
}
func (m *FillMaterializedViewRequest) XXX_Size() int {
	return m.Size()
}
func (m *FillMaterializedViewRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_FillMaterializedViewRequest.DiscardUnknown(m)
}

var xxx_messageInfo_FillMaterializedViewRequest proto.InternalMessageInfo

func (m *FillMaterializedViewRequest) GetBaseDbName() []byte {
	if m != nil {
		return m.BaseDbName
	}
	return nil
...
func (m *FillMaterializedViewRequest) GetBaseTableName() []byte {
	if m != nil {
...
func (m *FillMaterializedViewRequest) GetMvDbName() []byte {
	if m != nil {
		return m.MvDbName
	}
	return nil
...
func (m *FillMaterializedViewRequest) GetMvTableName() []byte {
	if m != nil {
		return m.MvTableName
	}
	return nil
}
...
func (m *FillMaterializedViewResponse) Reset()         { *m = FillMaterializedViewResponse{} }
func (m *FillMaterializedViewResponse) String() string { return proto.CompactTextString(m) }
...
func (m *FillMaterializedViewResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_FillMaterializedViewResponse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *FillMaterializedViewResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_FillMaterializedViewResponse.Merge(m, src)
}
func (m *FillMaterializedViewResponse) XXX_Size() int {
	return m.Size()
}
func (m *FillMaterializedViewResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_FillMaterializedViewResponse.DiscardUnknown(m)
}

var xxx_messageInfo_FillMaterializedViewResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterType((*FillMaterializedViewRequest)(nil), "mpp.FillMaterializedViewRequest")
	proto.RegisterType((*FillMaterializedViewResponse)(nil), "mpp.FillMaterializedViewResponse")
}
...
var fileDescriptor_819623c7fa76fc55 = []byte{
	...
	,
}
...
func (m *FillMaterializedViewRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.SelectQuery) > 0 {
		i -= len(m.SelectQuery)
		copy(dAtA[i:], m.SelectQuery)
		i = encodeVarintMpp(dAtA, i, uint64(len(m.SelectQuery)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.MvTableName) > 0 {
		i -= len(m.MvTableName)
		copy(dAtA[i:], m.MvTableName)
		i = encodeVarintMpp(dAtA, i, uint64(len(m.MvTableName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.MvDbName) > 0 {
		i -= len(m.MvDbName)
		copy(dAtA[i:], m.MvDbName)
		i = encodeVarintMpp(dAtA, i, uint64(len(m.MvDbName)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.BaseTableName) > 0 {
		i -= len(m.BaseTableName)
		copy(dAtA[i:], m.BaseTableName)
		i = encodeVarintMpp(dAtA, i, uint64(len(m.BaseTableName)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.BaseDbName) > 0 {
		i -= len(m.BaseDbName)
		copy(dAtA[i:], m.BaseDbName)
		i = encodeVarintMpp(dAtA, i, uint64(len(m.BaseDbName)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *FillMaterializedViewResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Error) > 0 {
		i -= len(m.Error)
		copy(dAtA[i:], m.Error)
		i = encodeVarintMpp(dAtA, i, uint64(len(m.Error)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *FillMaterializedViewRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FillMaterializedViewRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FillMaterializedViewRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BaseDbName", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BaseDbName = append(m.BaseDbName[:0], dAtA[iNdEx:postIndex]...)
			if m.BaseDbName == nil {
				m.BaseDbName = []byte{}
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BaseTableName", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.BaseTableName = append(m.BaseTableName[:0], dAtA[iNdEx:postIndex]...)
			if m.BaseTableName == nil {
				m.BaseTableName = []byte{}
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MvDbName", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MvDbName = append(m.MvDbName[:0], dAtA[iNdEx:postIndex]...)
			if m.MvDbName == nil {
				m.MvDbName = []byte{}
			}
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MvTableName", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.MvTableName = append(m.MvTableName[:0], dAtA[iNdEx:postIndex]...)
			if m.MvTableName == nil {
				m.MvTableName = []byte{}
			}
			iNdEx = postIndex
		case 5:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field SelectQuery", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SelectQuery = append(m.SelectQuery[:0], dAtA[iNdEx:postIndex]...)
			if m.SelectQuery == nil {
				m.SelectQuery = []byte{}
			}
			iNdEx = postIndex
		default:
...
func (m *FillMaterializedViewResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: FillMaterializedViewResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: FillMaterializedViewResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
